...
import styles from './HeadingWithEmbed.module.scss';
import type { HeadingWithEmbedTypes } from './HeadingWithEmbed.types';

export default function HeadingWithEmbed({ heading, paragraph, video, index }: HeadingWithEmbedTypes) {
  ...
  return (
    <section className={`${styles.section} max-width`}>
      ...
      <div className={styles.embed}>
        <iframe
          src={`https://player.vimeo.com/video/${video}?dnt=1&title=0&byline=0&portrait=0&loop=1`}
          title={heading}
          allowFullScreen
        />
      </div>
